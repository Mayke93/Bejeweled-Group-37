...
public class MouseListener extends MouseAdapter {
	 ...
	 * 
	 * @param board
	 *            , the board of the game where the mouse event takes place.
	 */
	...
	/**
	 * Method that sets the focus on the correct tile where the mouse was
	 * clicked.
	 */
	@Override
	public void mouseClicked(MouseEvent event) {
		...
		Logger.log("Mouse Clicked: ("
				+ game.getBoard().getTileAt(col, row).getLoc().x + ", "
